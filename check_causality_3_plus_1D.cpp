...
double pi00, pi01, pi02, pi03, pi11, pi12, pi13, pi22, pi23, pi33, Pi;
...
int main(int argc, char *argv[])
{
	...
	if (argc < 2)
	{
		...
		tau = 0.0; x = 0.0; y = 0.0;
		pi00 = 3.5078e-7; pi01 = 0.0013504; pi02 = -0.0045209; pi03 = 0.0;
		pi11 = 0.21482; pi12 = 0.00048869; pi13 = 0.0; 
		pi22 = 0.2144; pi23 = 0.0; pi33 = -0.42917;
		...
		if (infile.is_open())
		{
			...
			while ( getline (infile, line) )
			{
				...
				iss >> tau >> x >> y
					...
					>> pi00 >> pi01 >> pi02 >> pi03
					>> pi11 >> pi12 >> pi13 >> pi22 >> pi23 >> pi33 >> Pi
...
{
	double m[16];
	m[0]  = -pi00; m[1]  = -pi01; m[2]  = -pi02; m[3]  = -pi03;
	m[4]  =  pi01; m[5]  =  pi11; m[6]  =  pi12; m[7]  =  pi13;
	m[8]  =  pi02; m[9]  =  pi12; m[10] =  pi22; m[11] =  pi23;
	m[12] =  pi03; m[13] =  pi13; m[14] =  pi23; m[15] =  pi33;
